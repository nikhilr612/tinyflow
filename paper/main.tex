...
\paragraph{Results.} \todo{final FID with prior / real layouts, iris mismatch,
precision/recall and the figures below are filled in from \texttt{runs/wide\_rp\_300}
