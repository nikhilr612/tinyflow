...
\graphicspath{{../runs/wide_rp_300/figures/}{../runs/ablation/}{figures/}}
\newcommand{\figorplaceholder}[2]{%
  \IfFileExists{#1}{\includegraphics[width=#2]{#1}}{\fbox{\parbox{#2}{\centering\vspace{2em}\texttt{#1}\\(produced by \texttt{just paper})\vspace{2em}}}}}
