...
region-pool layer, flip-equivariant sampling, and re-noise-and-re-solve refinement
of finished samples with the model's own prior (SDEdit, \citealp{meng2022sdedit};
Restart sampling, \citealp{xu2023restart}; implemented in
\texttt{experiments/refine.py}, results pending) as the in-distribution alternative
to external upscalers. Shelved with reasons recorded: structured
